...
FILE_PATH = r"C:\Users\Lenovo\Desktop\spark_project\Weather.csv"
column = ['code','province','date','avg_temp','min_temp','max_temp','precipitation','max_wind_speed','most_wind_direction','avg_relative_humidity']
